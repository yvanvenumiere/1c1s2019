<?php 
			...
			/**
			 * wtags is a database object that can persist, delete and create forms for the wtags table
			 *
			 */
			
			class wtags extends baseModel
			{
			    ...
			    */
				public function __construct($rewriting=false)
				{
					...
					$this->tableName="wtags";
					
					parent::__construct($rewriting);
					
					
				$this->arrayFields["idwtags"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
				...
				$this->arrayFields["wtag_name"]=array
				(
					"type"=>"varchar(75)",
					"canBeNull"=>"NO",
					"key"=>"",
				...
				$this->arrayFields["wtag_code"]=array
				(
					"type"=>"varchar(10)",
					"canBeNull"=>"NO",
					"key"=>"",
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM wtags ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM wtags ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO wtags(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE wtags SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * wtagsDatasManager is a database object that list datas from the wtags table
			 *
			 */
			
			class wtagsDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM wtags ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM wtags ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM wtags ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
