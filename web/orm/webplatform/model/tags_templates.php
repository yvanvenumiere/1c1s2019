<?php 
			...
			/**
			 * tags_templates is a database object that can persist, delete and create forms for the tags_templates table
			 *
			 */
			
			class tags_templates extends baseModel
			{
			    ...
			    */
				public function __construct($rewriting=false)
				{
					...
					$this->tableName="tags_templates";
					
					parent::__construct($rewriting);
					
					
				$this->arrayFields["idtags_templates"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
				...
				$this->arrayFields["wtags_idwtags"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
				...
				$this->arrayRelations["wtags_idwtags"]=array
				(
					"assoc_table"=>"wtags",
					"assoc_col"=>"idwtags"
				);
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM tags_templates ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM tags_templates ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO tags_templates(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE tags_templates SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * tags_templatesDatasManager is a database object that list datas from the tags_templates table
			 *
			 */
			
			class tags_templatesDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM tags_templates ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM tags_templates ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM tags_templates ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
