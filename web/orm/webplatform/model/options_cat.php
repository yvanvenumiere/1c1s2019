<?php 
			...
			/**
			 * options_cat is a database object that can persist, delete and create forms for the options_cat table
			 *
			 */
			
			class options_cat extends baseModel
			{
			    ...
			    */
				public function __construct($rewriting=false)
				{
					...
					$this->tableName="options_cat";
					
					parent::__construct($rewriting);
					
					
				$this->arrayFields["idoptions_cat"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
					...
					"formLabel"=>"idoptions_cat"
				);
			
				$this->arrayFields["options_idoptions"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"options_idoptions"
				);
			
				$this->arrayFields["cat_prices_idcat_prices"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"cat_prices_idcat_prices"
				);
			
				$this->arrayFields["optcat_is_enabled"]=array
				(
					"type"=>"tinyint(4)",
					"canBeNull"=>"NO",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"optcat_is_enabled"
				);
			
					
				$this->arrayRelations["cat_prices_idcat_prices"]=array
				(
					"assoc_table"=>"cat_prices",
					"assoc_col"=>"idcat_prices"
				);
			
				$this->arrayRelations["options_idoptions"]=array
				(
					"assoc_table"=>"options",
					"assoc_col"=>"idoptions"
				);
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM options_cat ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM options_cat ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO options_cat(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE options_cat SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * options_catDatasManager is a database object that list datas from the options_cat table
			 *
			 */
			
			class options_catDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM options_cat ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM options_cat ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM options_cat ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
