<?php 
			...
			/**
			 * users is a database object that can persist, delete and create forms for the users table
			 *
			 */
			...
			class users extends baseModel
			{
			    ...
			    */
				...
				$this->arrayFields["idusers"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
				...
				$this->arrayFields["user_mail"]=array
				(
					"type"=>"varchar(100)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["user_mdp"]=array
				(
					"type"=>"varchar(32)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["user_date_creation"]=array
				(
					"type"=>"bigint(15)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"user_date_creation"
				);
			
				$this->arrayFields["profiles_idprofil"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"profiles_idprofil"
				);
			
				$this->arrayFields["user_nom"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["user_prenom"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"user_prenom"
				);
			
				$this->arrayFields["user_phone"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"user_phone"
				);
			
				$this->arrayFields["user_unique_tmp_id"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"user_unique_tmp_id"
				);
			
					
				$this->arrayRelations["profiles_idprofil"]=array
				(
					"assoc_table"=>"profiles",
					"assoc_col"=>"idprofil"
				);
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM users ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM users ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO users(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE users SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * usersDatasManager is a database object that list datas from the users table
			 *
			 */
			
			class usersDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM users ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM users ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM users ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
