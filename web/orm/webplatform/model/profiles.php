<?php 
			...
			/**
			 * profiles is a database object that can persist, delete and create forms for the profiles table
			 *
			 */
			...
			class profiles extends baseModel
			{
			    ...
			    */
				...
				$this->arrayFields["idprofil"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
				...
				$this->arrayFields["profil_name"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"NO",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"profil_name"
				);
			
				$this->arrayFields["profil_code"]=array
				(
					"type"=>"varchar(10)",
					"canBeNull"=>"NO",
					"key"=>"",
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM profiles ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM profiles ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO profiles(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE profiles SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * profilesDatasManager is a database object that list datas from the profiles table
			 *
			 */
			
			class profilesDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM profiles ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM profiles ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM profiles ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
