<?php 
			...
			/**
			 * paiements is a database object that can persist, delete and create forms for the paiements table
			 *
			 */
			
			class paiements extends baseModel
			{
			    ...
			    */
				...
				$this->arrayFields["idpaiements"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
					...
					"formLabel"=>"idpaiements"
				);
			
				$this->arrayFields["paiement_date_creation"]=array
				(
					"type"=>"bigint(15)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"paiement_date_creation"
				);
			
				$this->arrayFields["paiement_card_saved"]=array
				(
					"type"=>"tinyint(4)",
					"canBeNull"=>"YES",
					"key"=>"",
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM paiements ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM paiements ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO paiements(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE paiements SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * paiementsDatasManager is a database object that list datas from the paiements table
			 *
			 */
			
			class paiementsDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM paiements ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM paiements ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM paiements ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
