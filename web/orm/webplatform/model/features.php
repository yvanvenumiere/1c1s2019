<?php 
			...
			/**
			 * features is a database object that can persist, delete and create forms for the features table
			 *
			 */
			...
			class features extends baseModel
			{
			    ...
			    */
				...
				$this->arrayFields["idfeatures"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
					...
					"formLabel"=>"idfeatures"
				);
			
				$this->arrayFields["feature_text"]=array
				(
					"type"=>"varchar(120)",
					"canBeNull"=>"NO",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"feature_text"
				);
			
				$this->arrayFields["feature_class"]=array
				(
					"type"=>"varchar(55)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"feature_class"
				);
			
				$this->arrayFields["feature_order"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"YES",
					"key"=>"",
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM features ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM features ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO features(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE features SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * featuresDatasManager is a database object that list datas from the features table
			 *
			 */
			
			class featuresDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM features ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM features ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM features ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
