<?php 
			...
			/**
			 * cat_prices is a database object that can persist, delete and create forms for the cat_prices table
			 *
			 */
			
			class cat_prices extends baseModel
			{
			    ...
			    */
				public function __construct($rewriting=false)
				{
					...
					$this->tableName="cat_prices";
					
					parent::__construct($rewriting);
					
					
				$this->arrayFields["idcat_prices"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
					...
					"formLabel"=>"idcat_prices"
				);
			
				$this->arrayFields["cat_price_label"]=array
				(
					"type"=>"varchar(105)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"cat_price_label"
				);
			
				$this->arrayFields["cat_price_code"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"cat_price_code"
				);
			
				$this->arrayFields["cat_price_description"]=array
				(
					"type"=>"varchar(400)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"cat_price_description"
				);
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM cat_prices ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM cat_prices ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO cat_prices(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE cat_prices SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * cat_pricesDatasManager is a database object that list datas from the cat_prices table
			 *
			 */
			
			class cat_pricesDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM cat_prices ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM cat_prices ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM cat_prices ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
