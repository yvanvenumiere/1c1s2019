<?php 
			...
			/**
			 * website is a database object that can persist, delete and create forms for the website table
			 *
			 */
			...
			class website extends baseModel
			{
			    ...
			    */
				...
				$this->arrayFields["idwebsite"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
				...
				$this->arrayFields["website_name"]=array
				(
					"type"=>"varchar(100)",
					"canBeNull"=>"NO",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"website_name"
				);
			
				$this->arrayFields["w_templates_idw_templates"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"w_templates_idw_templates"
				);
			
				$this->arrayFields["website_date_creation"]=array
				(
					"type"=>"bigint(15)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"website_date_creation"
				);
			
				$this->arrayFields["w_hbp"]=array
				(
					"type"=>"tinyint(4)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["w_domain_name"]=array
				(
					"type"=>"varchar(85)",
					"canBeNull"=>"YES",
					"key"=>"",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"w_domain_name"
				);
			
				$this->arrayFields["w_code"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["db_instance_iddb_instance"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"db_instance_iddb_instance"
				);
			
				$this->arrayFields["users_idusers"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"MUL",
					"default"=>"",
					"extra"=>"",
					"formLabel"=>"users_idusers"
				);
			
					
				$this->arrayRelations["db_instance_iddb_instance"]=array
				(
					"assoc_table"=>"db_instance",
					"assoc_col"=>"iddb_instance"
				);
			
				$this->arrayRelations["users_idusers"]=array
				(
					"assoc_table"=>"users",
					"assoc_col"=>"idusers"
				);
			
				$this->arrayRelations["w_templates_idw_templates"]=array
				(
					"assoc_table"=>"w_templates",
					"assoc_col"=>"idw_templates"
				);
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM website ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM website ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO website(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE website SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * websiteDatasManager is a database object that list datas from the website table
			 *
			 */
			
			class websiteDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM website ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM website ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM website ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
