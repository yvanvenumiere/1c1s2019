<?php 
			...
			/**
			 * db_instance is a database object that can persist, delete and create forms for the db_instance table
			 *
			 */
			
			class db_instance extends baseModel
			{
			    ...
			    */
				public function __construct($rewriting=false)
				{
					...
					$this->tableName="db_instance";
					
					parent::__construct($rewriting);
					
					
				$this->arrayFields["iddb_instance"]=array
				(
					"type"=>"int(11)",
					"canBeNull"=>"NO",
					"key"=>"PRI",
					...
					"formLabel"=>"iddb_instance"
				);
			
				$this->arrayFields["dbi_host"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
				...
				$this->arrayFields["dbi_user"]=array
				(
					"type"=>"varchar(45)",
					"canBeNull"=>"YES",
					"key"=>"",
			    ...
			    */
				public function initFromDatas($arrayFilters)
				{
					...
					$sqlReq="SELECT * FROM db_instance ".$theWhere." LIMIT 1";
			    ...
			    */
				public function delete()
				{
					if($this->isSavedElement)
					{
						...
						$sqlDelete="DELETE FROM db_instance ".$theWhere."";
			    ...
			    */
				public function save($arrayFieldNames=null)
				{
					...
					$sqlInsert="INSERT INTO db_instance(".implode(",",$toSave).") values(".implode(",",$toSaveBinding).")";
			    ...
			    */
				public function update($arrayFieldNames=null)
				{
					...
					if($this->isSavedElement)
					{
						...
						$sqlUpdate="UPDATE db_instance SET ".implode(",",$toSave)." WHERE ".$this->getPrimaryKeyField()."=:".$this->getPrimaryKeyField()."";
			...
			/**
			 * db_instanceDatasManager is a database object that list datas from the db_instance table
			 *
			 */
			
			class db_instanceDatasManager extends baseModel
			{
			    ...
			    */
				...
				public function refreshNumElements()
				{
					...
					$sqlCount="SELECT COUNT(*) AS numElements FROM db_instance ".$this->getWhereClause();
				...
				{
					$sqlReq="SELECT * FROM db_instance ".$this->getWhereClause()." ".$this->getLimitClause($page)."";
				...
				{
					$sqlReq="SELECT ".$columns." FROM db_instance ".$supReq;
					$prepa=$this->dbh->prepare($sqlReq);
					if($qh)
					{$prepa->execute($qh);}
					else 
