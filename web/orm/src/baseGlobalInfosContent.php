<?php
function getGlobalInfos($adminPath,$base,$infosBase,$user,$mdp)
{
	$retour=
	'<?php 
/*
	...
	class globalInfos
	{
		...
		*/
		public function __construct($rewriting=false)
		{
			...
			$this->setSimpleInfo("admin_path","'.$adminPath.'");
			$this->setSimpleInfo("database_name","'.$base.'");
			$this->setSimpleInfo("database_infos","'.$infosBase.'");
			$this->setSimpleInfo("database_user","'.$user.'");
			$this->setSimpleInfo("database_password","'.$mdp.'");
